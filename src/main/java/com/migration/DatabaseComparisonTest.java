...
public class DatabaseComparisonTest {
    // Oracle 连接信息
    private static final String ORACLE_URL = "jdbc:oracle:thin:@//192.168.0.38:1521/XEPDB1";
    private static final String ORACLE_USER = "jdbc_test";
    private static final String ORACLE_PASSWORD = "JdbcTest123";

    // Snowflake 连接信息
    private static final String SNOWFLAKE_URL = "jdbc:snowflake://kamuiba_ko40672.snowflakecomputing.com/?db=MIGRATION_TRAINING&schema=PRACTICE&warehouse=COMPUTE_WH";//修改成自己的账号
    private static final String SNOWFLAKE_USER = "Oriana";//修改成自己的账号
    private static final String SNOWFLAKE_PASSWORD = "232510Wyj232510Wyj!";//修改成自己的账号
